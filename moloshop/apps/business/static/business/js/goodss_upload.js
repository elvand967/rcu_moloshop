...
// apps/business/static/business/js/goodss_upload.js
...
document.addEventListener("DOMContentLoaded", () => {
  const uploadForms = document.querySelectorAll(".goods-image-upload-form");

  uploadForms.forEach((form) => {
    const fileInput = form.querySelector(".goods-image-file");
    const selectBtn = form.querySelector(".select-goods-image-btn");
    const deleteBtn = form.querySelector(".delete-goods-image-btn");
    ...
    fileInput?.addEventListener("change", async (e) => {
      ...
      try {
        ...
        if (data.success) {
          ...
          const preview = container.querySelector(".goods-image-preview");
          if (preview) {
