...
#
# @admin.register(ProfileMenuCategory)
# class ProfileMenuCategoryAdmin(MPTTModelAdmin):
#     form = ProfileMenuCategoryForm
#     list_display = ("name", "parent", "order", "is_active_link", "url", "external_url", "updated_at")
#     list_editable = ("order", "is_active_link")
#     search_fields = ("name", "url", "external_url")
#     list_filter = ("is_active_link", "updated_at")
